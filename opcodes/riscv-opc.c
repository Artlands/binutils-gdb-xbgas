...
// {"elr.w",      0,  INSN_CLASS_I, "d,s",   MATCH_ELR_W, MASK_ELR_W, match_opcode, 0},
// {"esc.w",      0,  INSN_CLASS_I, "d,t,s", MATCH_ESC_W, MASK_ESC_W, match_opcode, 0},
// {"eamoswap.w", 0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOSWAP_W, MASK_EAMOSWAP_W, match_opcode, 0},
// {"eamoadd.w",  0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOADD_W, MASK_EAMOADD_W, match_opcode, 0},
// {"eamoxor.w",  0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOXOR_W, MASK_EAMOXOR_W, match_opcode, 0},
// {"eamoand.w",  0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOADD_W, MASK_EAMOADD_W, match_opcode, 0},
// {"eamoor.w",   0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOOR_W, MASK_EAMOOR_W, match_opcode, 0},
// {"eamomin.w",  0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOMIN_W, MASK_EAMOMIN_W, match_opcode, 0},
// {"eamomax.w",  0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOMAX_W, MASK_EAMOMAX_W, match_opcode, 0},
// {"eamominu.w", 0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOMINU_W, MASK_EAMOMINU_W, match_opcode, 0},
// {"eamomaxu.w", 0,  INSN_CLASS_I, "d,t,s", MATCH_EAMOMAXU_W, MASK_EAMOMAXU_W, match_opcode, 0},

// {"elr.d",      64, INSN_CLASS_I, "d,s",   MATCH_ELR_D, MASK_ELR_D, match_opcode, 0},
// {"esc.d",      64, INSN_CLASS_I, "d,t,s", MATCH_ESC_D, MASK_ESC_D, match_opcode, 0},
// {"eamoswap.d", 64, INSN_CLASS_I, "d,t,s", MATCH_EAMOSWAP_D, MASK_EAMOSWAP_D, match_opcode, 0},
// {"eamoadd.d",  64, INSN_CLASS_I, "d,t,s", MATCH_EAMOADD_D, MASK_EAMOADD_D, match_opcode, 0},
// {"eamoxor.d",  64, INSN_CLASS_I, "d,t,s", MATCH_EAMOXOR_D, MASK_EAMOXOR_D, match_opcode, 0},
// {"eamoand.d",  64, INSN_CLASS_I, "d,t,s", MATCH_EAMOADD_D, MASK_EAMOADD_D, match_opcode, 0},
// {"eamoor.d",   64, INSN_CLASS_I, "d,t,s", MATCH_EAMOOR_D, MASK_EAMOOR_D, match_opcode, 0},
// {"eamomin.d",  64, INSN_CLASS_I, "d,t,s", MATCH_EAMOMIN_D, MASK_EAMOMIN_D, match_opcode, 0},
// {"eamomax.d",  64, INSN_CLASS_I, "d,t,s", MATCH_EAMOMAX_D, MASK_EAMOMAX_D, match_opcode, 0},
// {"eamominu.d", 64, INSN_CLASS_I, "d,t,s", MATCH_EAMOMINU_D, MASK_EAMOMINU_D, match_opcode, 0},
// {"eamomaxu.d", 64, INSN_CLASS_I, "d,t,s", MATCH_EAMOMAXU_D, MASK_EAMOMAXU_D, match_opcode, 0},
/* Terminate the list.  */

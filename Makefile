...
BUILD_CONFIGARGS =  --cache-file=./config.cache  --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld  --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   --program-transform-name='s,y,y,' --disable-option-checking --disable-year2038 --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AR = ar 
AR_FLAGS = rc
CC = /opt/apps/nfs/spack/opt/spack/linux-centos8-zen/gcc-8.3.1/gcc-10.1.0-sxb46kmr635p5xyegs33nad4vyrz4skg/bin/gcc
CXX = /opt/apps/nfs/spack/opt/spack/linux-centos8-zen/gcc-8.3.1/gcc-10.1.0-sxb46kmr635p5xyegs33nad4vyrz4skg/bin/g++
DLLTOOL = dlltool
DSYMUTIL = dsymutil
LD = ld
LIPO = lipo
...
PKG_CONFIG_PATH = /opt/apps/nfs/spack/opt/spack/linux-centos8-zen2/gcc-10.1.0/openmpi-4.1.4-knikhj2xs4j75k3pwa5lhqancnv5pyrq/lib/pkgconfig
